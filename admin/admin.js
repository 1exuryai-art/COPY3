...
const BARBER_SERVICE_CHECKBOXES = [
  { id: "hybrid-manicure", label: "Manicure hybrydowy" },
  { id: "gel-extension", label: "Przedłużanie żelowe" },
  { id: "nail-art", label: "Zdobienia" },
    ...
    serviceCategories: [
      {
        ...
        description: {
          pl: "Najczęściej wybierane stylizacje w Luna Nail Studio.",
          ru: "Самые популярные услуги в Luna Nail Studio.",
          en: "Most booked services at Luna Nail Studio."
        },
        visible: true,
        order: 1
      },
      {
        id: "care",
        title: { pl: "Pielęgnacja", ru: "Уход", en: "Care" },
        description: {
          pl: "Usługi pielęgnacyjne dłoni i paznokci.",
          ru: "Уходовые услуги для рук и ногтей.",
          en: "Hand and nail care services."
        },
        visible: true,
        order: 2
      },
      {
        id: "design",
        title: { pl: "Styl i design", ru: "Стиль и дизайн", en: "Style and design" },
        description: {
          pl: "French, babyboomer i detale premium.",
          ru: "French, babyboomer и премиальные детали.",
          en: "French, baby boomer and premium details."
        },
        visible: true,
        order: 3
      }
    ...
    services: [
      {
        ...
        description: "Czysty manicure z trwałym kolorem dopasowanym do stylu klientki.",
        basePrice: 120,
        discountedPrice: "",
        duration: "1h 30min",
        durationMinutes: 90,
      ...
      },
      {
        ...
        description: "Budowa i kształt paznokci z estetycznym wykończeniem premium.",
        basePrice: 180,
        discountedPrice: "",
        duration: "2h",
        durationMinutes: 120,
      ...
      },
      {
        ...
        category: "design",
        name: "Zdobienia",
        description: "French, babyboomer lub subtelny detal dopasowany do stylizacji.",
        basePrice: 35,
        discountedPrice: "",
        duration: "20min",
        durationMinutes: 20,
    ...
    barbers: [
      {
        ...
        description: "Clean manicure, subtelne kolory i naturalny efekt.",
        languages: ["PL Polski", "UA Українська", "EN English"]
      },
      {
        id: "ola",
        name: "Ola",
        photo: "/images/masters/ola-1x1.png",
        description: "French, baby boomer i minimalistyczne zdobienia.",
      ...
      },
      {
        ...
        description: "Żel, przedłużanie i mocniejsze stylizacje premium.",
        languages: ["PL Polski", "UA Українська", "RU Русский"]
      }
    ],
    discount: {
      enabled: true,
...
const EMPTY_COPY = {
  ...
  barbers: ["Nie ma jeszcze żadnej stylistki.", "Kliknij „+ Dodaj stylistkę” i uzupełnij pierwszą kartę."],
  landingServices: [
...
function renderBarbersEditor(container) {
  ...
  const head = `
    <button type="button" class="dogma-btn dogma-btn--primary dogma-btn--block-sm" data-add-barber>+ Dodaj stylistkę</button>
  ...
  const blocks = list
    .map((item, idx) => {
      ...
      <div class="dogma-item dogma-card" data-list="barbers" data-index="${idx}" data-preview-lang="pl">
        ...
        <h4 class="dogma-section-title">2. Zdjęcie stylistki</h4>
        ...
        <details class="dogma-details dogma-details--tech">
          ...
          <div class="dogma-field">
            <label>Wewnętrzny identyfikator stylistki (np. maja)</label>
            <input type="text" data-field="barberId" value="${esc(item.barberId || "")}" placeholder="maja" />
          </div>
        </details>
...
function buildBookingServiceCardHtml(svc, svcIdx, cfg) {
  ...
  return `
      <details class="dogma-subcard dogma-subcard--booking-svc dogma-collapsible-svc dogma-search-mark" data-b-svc="${svcIdx}">
        ...
        <div class="dogma-field dogma-field--inline"><label><input type="checkbox" data-svc-any ${svc.allowClientBarberChoice !== false ? "checked" : ""} /> Klient może wybrać stylistkę z listy</label></div>
